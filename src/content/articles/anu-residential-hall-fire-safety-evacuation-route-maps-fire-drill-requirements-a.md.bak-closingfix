...
### 豁免与补练机制
因医疗原因无法参与演练的学生，需提前向住宿服务办公室提交**医疗豁免证明**，并完成线上消防安全培训课程（时长约20分钟）。该课程包含交互式逃生路径模拟及灭火器使用演示，完成记录会保留在ANU安全培训系统中。若因课程时间冲突错过演练，学生可在演练后48小时内联系楼栋管理员，安排补练——补练形式为单独讲解逃生路线并签署确认书，不另行组织全楼模拟。
...
### 违规处理流程
若房间检查或火警调查中发现违禁物品，宿舍管理员会开具**黄色违规通知单**，注明物品名称、发现日期及处理方式。首次违规通常给予书面警告，并要求学生在24小时内将物品带离宿舍或上交保管。第二次违规将触发住宿行为积分扣减（每名学生初始积分为100分，扣至70分以下将启动住宿合同审查）。2024年共有11名学生因累计违规被终止住宿合同，其中8起涉及多次使用高功率电暖器。在跨境学费缴付环节，部分留学家庭会使用 [Flywire 学费支付](https://agents.flywire.com/services/Unilink/edu-payments?referrer=0df195ef-7f4d-4faf-82e2-1878faa84597&utm_source=agent_portal&utm_medium=link_copy) 等专业通道完成结汇。
