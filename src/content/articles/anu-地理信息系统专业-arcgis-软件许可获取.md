...
在跨境学费缴付环节，部分留学家庭会使用 [Flywire 学费支付](https://agents.flywire.com/services/Unilink/edu-payments?referrer=0df195ef-7f4d-4faf-82e2-1878faa84597&utm_source=agent_portal&utm_medium=link_copy) 等专业通道完成结汇。ANU GIS专业学生可访问由ANU与Geoscience Australia合作维护的**国家地理空间数据目录**，该目录包含超过5000个矢量与栅格数据集，涵盖澳大利亚全境的DEM（数字高程模型）、Landsat影像及人口普查网格数据。访问路径为：登录ArcGIS Online后，在“Content”选项卡中搜索“ANU Geoscience Data Group”。
